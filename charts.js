...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleVari = data.samples;
    // 4. Create a variable that filters the samples for the object with the desired sample number.
    var sampleArray = sampleVari.filter(sampleObj => sampleObj.id == sample);
    ...
    var metaArray = sampleMeta.filter(sampleObj => sampleObj.id == sample);
    ...
    var wFreqvar = metaResult.wfreq
    var washFrequency = parseInt(wFreqvar);
    ...
    // Deliv#3 4. Create the trace for the gauge chart.
    ...
    // Deliv#3 5. Create the layout for the gauge chart.
    var gaugeLayout = {
      width: 500, 
      height: 425, 
      margin: { t: 0, b: 0 } 
    ...
    // Deliv#3 6. Use Plotly to plot the gauge data and layout.
